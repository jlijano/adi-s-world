const CACHE_NAME = "adis-world-v73";
const APP_SHELL = [
  "./", "./index.html",
  "./styles.css?v=73", "./drawing-garden.css?v=37", "./outfit-check.css?v=63", "./outfit-check-layered.css?v=70",
  "./app.js?v=73", "./drawing-garden.js?v=37", "./outfit-check.js?v=70",
  ...
  "./assets/icons/icon.svg", "./assets/icons/adis-world-splash.jpg", "./assets/worlds/word-forest-card.svg?v=73",
