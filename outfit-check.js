(() => {
  ...
  function renderAvatar() {
    return `
      <div class="outfit-avatar-wrap">
        ...
        <div class="${avatarClasses()}" id="outfit-avatar" style="--adi-turn:${rotation}deg" role="img" aria-label="Adi wearing the selected outfit">
          <div class="adi-shadow"></div>
          <div class="adi-body-3d">
            <div class="adi-hair-back"></div>
            <div class="adi-pigtail adi-pigtail-left"><span class="adi-bow"></span></div>
            <div class="adi-pigtail adi-pigtail-right"><span class="adi-bow"></span></div>
            <div class="adi-head">
              <div class="adi-fringe"></div>
              <div class="adi-headband-piece"></div>
              <span class="adi-eye adi-eye-left"></span>
              <span class="adi-eye adi-eye-right"></span>
              <span class="adi-cheek adi-cheek-left"></span>
              <span class="adi-cheek adi-cheek-right"></span>
              <span class="adi-mouth"></span>
            </div>
            <div class="adi-neck"></div>
            <div class="adi-torso">
              <div class="adi-shirt-detail"></div>
              <div class="adi-necklace-piece"><span></span></div>
            </div>
            <div class="adi-arm adi-arm-left"></div>
            <div class="adi-arm adi-arm-right">
              <span class="adi-wrist-piece"></span>
              <span class="adi-watch-piece"></span>
            </div>
            <div class="adi-bottom"></div>
            <div class="adi-leg adi-leg-left"></div>
            <div class="adi-leg adi-leg-right"></div>
            <div class="adi-shoe adi-shoe-left"></div>
            <div class="adi-shoe adi-shoe-right"></div>
          </div>
        </div>
        <div class="outfit-turn-controls" aria-label="Turn Adi">
          <button type="button" data-outfit-turn="-30" aria-label="Turn Adi left">↶</button>
          <span>Turn Adi</span>
          <button type="button" data-outfit-turn="30" aria-label="Turn Adi right">↷</button>
        </div>
      </div>`;
  }
  ...
  document.addEventListener("click", (event) => {
    ...
    if (turnButton && currentView?.type === "outfit-check") {
      rotation = Math.max(-45, Math.min(45, rotation + Number(turnButton.dataset.outfitTurn || 0)));
